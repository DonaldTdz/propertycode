...
{
    public class PrePaymentdeductionDetailReportDTO
    {
        /// <summary>
        /// 资源名称 
        /// </summary>
        ...
        public string DoorNoResourcesName
        {
            get
            {
                if(ResourcesName.Equals(HouseDoorNo) || string.IsNullOrEmpty(HouseDoorNo))
                {
                    return ResourcesName;
                }
                else
                {
                    return HouseDoorNo + string.Format("({0})", ResourcesName);
                }
