...
{
    public class ZNMSServiceController : ApiController
    {
        [HttpPost]
        public JsonResult<APIResultDTO> GetUserDeptInfoById([FromBody]ParameterModel model)
        {
            Guid guid;
            ...
            try
            {
                guid = new Guid(model.userOwnerId);
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult<APIResultDTO> GetKeysByOwnerId([FromBody]ParameterModel model)
        {
            ...
            APIResultDTO jsonResult = new APIResultDTO();
            ...
            catch (Exception ex)
            {
                ...
                jsonResult.Code = 2;
                jsonResult.Message = dic[2];
                jsonResult.Data = new List<EntranceKey>();
            ...
            try
            {
                ...
                if (keyList.Count > 0)
                {
                    ...
                    jsonResult.Code = 0;
                    jsonResult.Message = dic[3];
                    jsonResult.Data = keyList.Select(o => new EntranceKey { KeyExpireTime = o.KeyExpireTime, Name = o.Name, KeyID = o.KeyID, VillageName = o.VillageName }).ToList();
                    return Json(jsonResult);
                }
                else
                {
        ...
        /// /获取单元锁
        /// </summary>
        private DataTable DSKeyUnit(string userId)
        {
        ...
        /// 根据小区单元获得小区楼栋 
        /// </summary>
        private DataTable DSKeyBuild(string builds)
        {
            DataTable dt = new DataTable();
